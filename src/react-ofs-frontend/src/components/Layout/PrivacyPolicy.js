...
const PrivacyPolicy = () =>  {
    return (
        <>
        <h1>Privacy Policy for OFS Platform</h1>
...
This privacy policy is written based on the “handbook of applied GPDR in Oman”, but it’s always good to check with local legal expert for more accurate information.
    </>
    )
}
